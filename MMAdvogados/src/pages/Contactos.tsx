...
const Contactos = () => {
  const contactInfo = {
    ...
    phone: "+258845305689",
    address: "Av.joaquim Chissano, 1919- Fomento- Matola Matola- fomento, Matola, Moçambique",
  ...
  const businessHours = [
    ...
    { day: "segunda-feira", hours: "08:00–17:00", note: "(Dia dos Acordos de Lusaka (observado))" },
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Entre em contacto connosco para obter assessoria jurídica especializada. 
              Estamos aqui para ajudar com todas as suas necessidades legais.
            </p>
          </div>
        </div>
      </section>
            ...
            <div className="space-y-6">
              ...
              <Card className="border-primary/20 hover:border-primary/40 transition-all duration-300">
                ...
                <CardContent>
                  ...
                  <a
                    href={generateWhatsAppLink(contactInfo.whatsapp, getWhatsAppMessage())}
                    target="_blank"
                ...
                <CardContent>
                  ...
                  <div className="mt-6 p-4 bg-amber-50 border border-amber-200 rounded-lg">
                    <p className="text-sm text-amber-800">
                      <strong>Nota:</strong> O horário de funcionamento pode ser diferente em feriados e datas especiais.
                    </p>
                  </div>
                </CardContent>
              </Card>
