        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="space-y-12">
                ...
                <ul className="space-y-3 ml-6">
                  <li className="flex items-start">
                    ...
                    <span className="text-foreground">
                      <strong>Informações de identificação:</strong> Nome,
                      número de identificação, data de nascimento, nacionalidade
                    </span>
                  </li>
                  <li className="flex items-start">
                    <span className="w-2 h-2 bg-primary rounded-full mt-2 mr-3 flex-shrink-0" />
                    <span className="text-foreground">
                      <strong>Informações de contacto:</strong> Endereço,
                  ...
                  <li className="flex items-start">
                    <span className="w-2 h-2 bg-primary rounded-full mt-2 mr-3 flex-shrink-0" />
                    <span className="text-foreground">
                      <strong>Informações profissionais:</strong> Cargo,
                      empresa, informações laborais
                    </span>
                  </li>
                  <li className="flex items-start">
                    <span className="w-2 h-2 bg-primary rounded-full mt-2 mr-3 flex-shrink-0" />
                  ...
                  <li className="flex items-start">
                    ...
                    <span className="text-foreground">
                      ...
                      cookies, dados de navegação do website
                    </span>
                  </li>
                </ul>
              </CardContent>
            ...
            <Card className="border-primary/20">
              ...
              <CardContent className="space-y-4">
                <p className="text-foreground leading-relaxed">
                  Utilizamos as suas informações pessoais para os seguintes
                  fins:
                </p>
                <ul className="space-y-3 ml-6">
                  <li className="flex items-start">
              ...
              <CardContent className="space-y-4">
                ...
                <ul className="space-y-3 ml-6">
                  <li className="flex items-start">
                    <span className="w-2 h-2 bg-primary rounded-full mt-2 mr-3 flex-shrink-0" />
                    <span className="text-foreground">
                      <strong>Com o seu consentimento:</strong> Quando autorizar
                      explicitamente
                    </span>
                  </li>
                  <li className="flex items-start">
                  ...
                  <li className="flex items-start">
                    ...
                    <span className="text-foreground">
                      ...
                      ajudam a prestar serviços (sempre com proteções adequadas)
                    </span>
                  </li>
                  <li className="flex items-start">
                    <span className="w-2 h-2 bg-primary rounded-full mt-2 mr-3 flex-shrink-0" />
                    <span className="text-foreground">
                      <strong>Proteção de direitos:</strong> Para proteger os
                      nossos direitos legais ou de terceiros
                    </span>
                  </li>
                </ul>
              </CardContent>
            ...
            <Card className="border-primary/20">
              ...
              <CardContent className="space-y-4">
                <p className="text-foreground leading-relaxed">
                  ...
                  adequadas para proteger as suas informações pessoais contra:
                </p>
                <ul className="space-y-3 ml-6">
                  <li className="flex items-start">
                    <span className="w-2 h-2 bg-primary rounded-full mt-2 mr-3 flex-shrink-0" />
                ...
                <p className="text-foreground leading-relaxed">
                  Estas medidas incluem encriptação, firewalls, controlos de
                  acesso e formação regular da nossa equipa sobre proteção de
                  dados.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-primary/20">
              ...
              <CardContent className="space-y-4">
                <p className="text-foreground leading-relaxed">
                  Tem os seguintes direitos relativamente aos seus dados
                  pessoais:
                </p>
                <ul className="space-y-3 ml-6">
                  <li className="flex items-start">
                    <span className="w-2 h-2 bg-primary rounded-full mt-2 mr-3 flex-shrink-0" />
                    <span className="text-foreground">
                      <strong>Acesso:</strong> Solicitar informações sobre os
                      dados que temos
                    </span>
                  </li>
                  <li className="flex items-start">
                    <span className="w-2 h-2 bg-primary rounded-full mt-2 mr-3 flex-shrink-0" />
                    <span className="text-foreground">
                      <strong>Retificação:</strong> Corrigir dados inexatos ou
                      incompletos
                    </span>
                  </li>
                  <li className="flex items-start">
                    <span className="w-2 h-2 bg-primary rounded-full mt-2 mr-3 flex-shrink-0" />
                    <span className="text-foreground">
                      <strong>Eliminação:</strong> Solicitar a remoção dos seus
                      dados
                    </span>
                  </li>
                  <li className="flex items-start">
                ...
                <p className="text-foreground leading-relaxed">
                  Para exercer estes direitos, contacte-nos através dos dados de
                  contacto fornecidos no final desta política.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-primary/20">
              ...
              <CardContent className="space-y-4">
                <p className="text-foreground leading-relaxed">
                  ...
                  o tratamento dos seus dados pessoais, contacte-nos:
                </p>
