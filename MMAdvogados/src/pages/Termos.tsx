        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Condições e termos que regem a utilização dos nossos serviços e website, 
              estabelecendo os direitos e obrigações de ambas as partes.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="space-y-12">
            ...
            <Card className="border-primary/20">
              ...
              <CardContent className="space-y-4">
                <p className="text-foreground leading-relaxed">
                  Estes Termos de Uso ("Termos") regem a utilização do website e serviços 
                  da Milagrosa Macuácua Advogados, LDA ("nós", "nosso", "nossa"). 
                  Ao aceder ao nosso website ou utilizar os nossos serviços, concorda em 
                  cumprir estes Termos.
                </p>
                <p className="text-foreground leading-relaxed">
                  Estes Termos aplicam-se a todos os utilizadores do website, clientes 
                  e potenciais clientes da nossa sociedade de advogados.
                </p>
              ...
              <CardContent className="space-y-4">
                ...
                <ul className="space-y-3 ml-6">
                  ...
                  <li className="flex items-start">
                    <span className="w-2 h-2 bg-primary rounded-full mt-2 mr-3 flex-shrink-0" />
                    <span className="text-foreground">
                      Aceita cumprir todos os termos e condições aqui estabelecidos
                    </span>
                  </li>
                  <li className="flex items-start">
                    <span className="w-2 h-2 bg-primary rounded-full mt-2 mr-3 flex-shrink-0" />
            ...
            <Card className="border-primary/20">
              ...
              <CardContent className="space-y-4">
                <p className="text-foreground leading-relaxed">
                  A Milagrosa Macuácua Advogados, LDA presta os seguintes serviços jurídicos:
                </p>
                <ul className="space-y-3 ml-6">
                  <li className="flex items-start">
                    <span className="w-2 h-2 bg-primary rounded-full mt-2 mr-3 flex-shrink-0" />
                    <span className="text-foreground">
                      <strong>Contencioso e Arbitragem:</strong> Representação em tribunais e processos arbitrais
                    </span>
                  </li>
                  <li className="flex items-start">
                    <span className="w-2 h-2 bg-primary rounded-full mt-2 mr-3 flex-shrink-0" />
                    <span className="text-foreground">
                      <strong>Corporate:</strong> Assessoria em operações empresariais e M&A
                    </span>
                  </li>
                  <li className="flex items-start">
                    <span className="w-2 h-2 bg-primary rounded-full mt-2 mr-3 flex-shrink-0" />
                    <span className="text-foreground">
                      <strong>Direito Administrativo e Fiscal:</strong> Consultoria fiscal e aduaneira
                    </span>
                  </li>
                  <li className="flex items-start">
                    <span className="w-2 h-2 bg-primary rounded-full mt-2 mr-3 flex-shrink-0" />
                    <span className="text-foreground">
                      <strong>Imobiliária e Terras:</strong> Assessoria em transações imobiliárias
                    </span>
                  </li>
                  <li className="flex items-start">
                    <span className="w-2 h-2 bg-primary rounded-full mt-2 mr-3 flex-shrink-0" />
                    <span className="text-foreground">
                      <strong>Laboral e Migração:</strong> Gestão de relações laborais e vistos
                    </span>
                  </li>
                  <li className="flex items-start">
                    <span className="w-2 h-2 bg-primary rounded-full mt-2 mr-3 flex-shrink-0" />
                    <span className="text-foreground">
                      <strong>Societário:</strong> Constituição e reestruturação de empresas
                    </span>
                  </li>
                  <li className="flex items-start">
                    <span className="w-2 h-2 bg-primary rounded-full mt-2 mr-3 flex-shrink-0" />
                    <span className="text-foreground">
                      <strong>Recuperação de Créditos:</strong> Estratégias de cobrança e recuperação
                    </span>
                  </li>
                </ul>
              </CardContent>
            ...
            <Card className="border-primary/20">
              ...
              <CardContent className="space-y-4">
                <p className="text-foreground leading-relaxed">
                  Todo o conteúdo do nosso website, incluindo mas não limitado a:
                </p>
                <ul className="space-y-3 ml-6">
                  <li className="flex items-start">
                    <span className="w-2 h-2 bg-primary rounded-full mt-2 mr-3 flex-shrink-0" />
                ...
                <p className="text-foreground leading-relaxed">
                  É propriedade da Milagrosa Macuácua Advogados, LDA e está protegido 
                  pelas leis de propriedade intelectual. É proibida a reprodução, 
            ...
            <Card className="border-primary/20">
              ...
              <CardContent className="space-y-4">
                ...
                <p className="text-foreground leading-relaxed">
                  ...
                  dos honorários pagos pelo cliente no período de 12 meses anteriores.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-primary/20">
              ...
              <CardContent className="space-y-4">
                <p className="text-foreground leading-relaxed">
                  Comprometemo-nos a manter a confidencialidade de todas as informações 
                  partilhadas pelos nossos clientes, em conformidade com:
                </p>
                <ul className="space-y-3 ml-6">
                  <li className="flex items-start">
                    <span className="w-2 h-2 bg-primary rounded-full mt-2 mr-3 flex-shrink-0" />
                ...
                <p className="text-foreground leading-relaxed">
                  Todas as informações partilhadas durante a prestação de serviços 
                  são tratadas com o máximo sigilo e segurança.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-primary/20">
              ...
              <CardContent className="space-y-4">
                <p className="text-foreground leading-relaxed">
                  Estes Termos podem ser rescindidos nas seguintes circunstâncias:
                </p>
                <ul className="space-y-3 ml-6">
                  <li className="flex items-start">
                    <span className="w-2 h-2 bg-primary rounded-full mt-2 mr-3 flex-shrink-0" />
                  ...
                  <li className="flex items-start">
                    <span className="w-2 h-2 bg-primary rounded-full mt-2 mr-3 flex-shrink-0" />
                    <span className="text-foreground">
                      <strong>Por decisão judicial:</strong> Quando ordenado por tribunal
                    </span>
                  </li>
                </ul>
                <p className="text-foreground leading-relaxed">
            ...
            <Card className="border-primary/20">
              ...
              <CardContent className="space-y-4">
                <p className="text-foreground leading-relaxed">
                  ...
                  Qualquer disputa será resolvida nos tribunais moçambicanos, 
                  com jurisdição exclusiva em Maputo.
                </p>
                <p className="text-foreground leading-relaxed">
                  Em caso de conflito entre estes Termos e a legislação aplicável, 
                  prevalece a legislação moçambicana.
                </p>
              </CardContent>
            </Card>
